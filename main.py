...
def main():
    ...
    SECRET_DIR            = CONFIG.get('SECRET_DIR')
    SECRET_PATH           = Path(SECRET_DIR).resolve()

    ROUTER_DHCP_FILENAME  = CONFIG.get('ROUTER_DHCP_FILENAME')
    ROUTER_DHCP_PATH      = SECRET_PATH / ROUTER_DHCP_FILENAME

    KNOWN_MACS_FILENAME   = CONFIG.get('KNOWN_MACS_FILENAME')
    KNOWN_MACS_PATH       = SECRET_PATH / KNOWN_MACS_FILENAME

    UNKNOWN_MACS_FILENAME = CONFIG.get('UNKNOWN_MACS_FILENAME')
